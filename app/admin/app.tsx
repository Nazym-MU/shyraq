...
const App = () => {
    return (
        <Admin dataProvider={dataProvider}>
            ...
            <Resource name="challengeOptions" list={ChallengeOptionList} create={ChallengeOptionCreate} edit={ChallengeOptionEdit} recordRepresentation="text" options={{ label: "Challenge Options" }} />
        </Admin>
    );
}
